Shopify Discount Functions app for `noairproducts`
...
This template uses [Drizzle](https://orm.drizzle.team/) to store session data, by default using a [D1](https://developers.cloudflare.com/d1/) database.
